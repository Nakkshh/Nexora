...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-br from-gray-50 via-white to-gray-100 border-t border-gray-200 py-12 sm:py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
          ...
          {/* Developer Section */}
          <div>
            <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">Developer</h4>
